...
?>
				<li class="nav-item">
					<a class="nav-link" href="?p=<?php echo $row["menu_link"]; ?>">
						...
						<span class="menu-title"><?php echo $row["menu_name"]; ?></span>
					</a>
				</li>
			<?php
			}
			...
			?>
				<div class="all-s">
					...
					<div class="panel-body">
						...
						<div class="row form-group">
							<div class="col-md-3"><strong>รูปภาพ</strong></div>
							<div class="col-md-9">
								<?php
								...
								?>
									<img style="width: 100%;" src="../upload_images/<?php echo $row["repair_img"] ?>">
							</div>
						<?php
								}
						?>
