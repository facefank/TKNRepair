		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					?>
						<div class="status-add-suc">
							<p>กรุณาจดเลขแจ้งซ่อมที่ขึ้นอยู่บนตารางล่าสุด อัพโหลดข้อมูลเรียบร้อย</p>
						</div>
					<?php
					} else if ($status_add == "") {
						echo "";
					...
					?>
						<div class="status-add-f">
							<p>แจ้งเตือนไปยัง IT ไม่สำเร็จ</p>
						</div>
					<?php
					}
					?>
					...
					switch ($_GET["p"]) {
						...
						case "qrcode";
							...
							break;
						case "reportink";
							include "reportink.php";
							break;
						case "comdetail";
							include "comdetail.php";
							break;
						case "printerdetail";
							include "printerdetail.php";
							break;
						default:
					?>
				...
				<footer class="footer">
					<div class="container-fluid clearfix">
						...
						<a href="#" target="_blank">IT Toyota Kaennakorn</a></span>
					</div>
				</footer>
				<!-- partial -->
			</div>
